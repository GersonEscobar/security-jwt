...
public class SecurityConfig implements WebMvcConfigurer {
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST,"/marcajes/entrada/**").hasAnyAuthority("USER", "ADMIN")
                        .requestMatchers(HttpMethod.GET,"/marcajes/entrada/**").hasAnyAuthority("USER", "ADMIN")
                        .requestMatchers(HttpMethod.POST,"/marcajes/salida/**").hasAnyAuthority("USER", "ADMIN")
                        ...
                        .requestMatchers(HttpMethod.DELETE,"/usuarios/**").hasAnyAuthority("ADMIN")
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(Arrays.asList("http://18.219.196.79", "http://localhost:4200"));
